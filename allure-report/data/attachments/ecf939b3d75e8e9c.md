          ...
          - generic [ref=e909]:
            ...
            - generic [ref=e950]:
              ...
              - generic [ref=e969] [cursor=pointer]:
                ...
                - generic [ref=e976]:
                  - generic [ref=e977]:
                    - generic [ref=e978]: TYPE
                    - generic [ref=e979]: Fixed
                  - generic [ref=e980]:
                    - generic [ref=e981]: BONUS PERCENT
                    - generic [ref=e982]: 12%
                  - generic [ref=e983]:
                    - generic [ref=e984]: PAYOUT MONTH
                    - generic [ref=e985]: 01-Dec-2026
              - button "Add Bonus" [ref=e986] [cursor=pointer]:
                - generic [ref=e987]:
                  - img [ref=e988]
                  - text: Add Bonus
            - generic [ref=e989]: Payroll Details
            - generic [ref=e990]:
              - generic [ref=e991]:
                - generic [ref=e993] [cursor=pointer]:
                  - checkbox "Provident Fund (PF) eligible" [checked] [ref=e995]
                  - generic [ref=e997]: Provident Fund (PF) eligible
                - generic [ref=e999] [cursor=pointer]:
                  - checkbox "ESI eligible" [ref=e1001]
                  - generic [ref=e1003]: ESI eligible
                - generic [ref=e1005] [cursor=pointer]:
                  - checkbox "LWF eligible" [checked] [ref=e1007]
                  - generic [ref=e1009]: LWF eligible
              - generic [ref=e1014]:
                - generic [ref=e1017]: Tax Regime to Consider
                - generic [ref=e1021] [cursor=pointer]:
                  - generic [ref=e1023]:
                    - combobox "Tax Regime to Consider" [ref=e1025]
                    - generic "Old Regime" [ref=e1026]
                  - generic:
                    - img
          - generic [ref=e1032]:
            - generic [ref=e1033]:
              - generic [ref=e1034]: Salary Breakup
              - generic [ref=e1035]:
                - generic [ref=e1036]:
                  - text: Salary Effective from
                  - generic [ref=e1037]: (24-Apr-2025)
                - generic [ref=e1038]:
                  - switch [ref=e1039] [cursor=pointer]
                  - generic [ref=e1042]: Detailed Breakup
            - generic [ref=e1043]:
              - generic [ref=e1044]:
                - generic [ref=e1045]: Regular Salary
                - generic [ref=e1046]: INR 15000
              - img [ref=e1048]
              - generic [ref=e1049]:
                - generic [ref=e1050]: Bonus
                - generic [ref=e1051]: INR 2550
              - generic [ref=e1052]: =
              - generic [ref=e1053]:
                - generic [ref=e1054]: Total
                - generic [ref=e1055]: INR 12450
      - generic [ref=e1057]:
        - button "Previous" [ref=e1058] [cursor=pointer]:
          - generic [ref=e1059]: Previous
        - button "Create" [ref=e1060] [cursor=pointer]:
          - generic [ref=e1061]: Create
  - generic [ref=e1062]:
    - dialog:
      - generic [ref=e1063]:
        - button "Close" [ref=e1064] [cursor=pointer]:
          - generic "Close" [ref=e1065]:
            - img "close" [ref=e1066]:
              - img [ref=e1067]
        - generic [ref=e1070]:
          - img "icon" [ref=e1072]
          - generic [ref=e1073]:
            - heading "Confirm Onboarding Email" [level=5] [ref=e1074]
            - paragraph [ref=e1075]: You are about to create a new employee profile. Would you like to send an onboarding email to the employee?
            - generic [ref=e1076] [cursor=pointer]:
              - checkbox "Send Onboarding Email" [checked] [ref=e1078]
              - generic [ref=e1080]: Send Onboarding Email
            - generic [ref=e1081]:
              - button "Cancel" [ref=e1082] [cursor=pointer]:
                - generic [ref=e1083]: Cancel
              - button "Confirm" [active] [ref=e1084] [cursor=pointer]:
                - generic [ref=e1085]: Confirm
```
