...
class BaseStep {
  ...
  async selectAntDropdown(fieldKey, value, label = fieldKey) {
    ...
    try {
      ...
      this.ctx.log(`selectAntDropdown [${fieldKey}]: ${err.message}`, "error");
      throw new Error(`Dropdown "${fieldKey}" failed: ${err.message}`);
    }
  }
  ...
  async selectAntDropdownMulti(fieldKey, values = [], label = fieldKey) {
    ...
    try {
      ...
      this.ctx.log(`selectAntDropdownMulti [${fieldKey}]: ${err.message}`, "error");
      throw new Error(`Multi-dropdown "${fieldKey}" failed: ${err.message}`);
    }
  }
  ...
  async setCheckbox(fieldKey, value) {
    ...
    try {
      ...
      this.ctx.log(`setCheckbox [${fieldKey}]: ${err.message}`, "error");
      throw new Error(`Checkbox "${fieldKey}" failed: ${err.message}`);
    }
  }
  ...
  async selectRadio(fieldKey, value) {
    ...
    try {
      ...
      this.ctx.log(`selectRadio [${fieldKey}]: ${err.message}`, "error");
      throw new Error(`Radio "${fieldKey}" failed: ${err.message}`);
    }
  }
  ...
  async validateField(fieldKey) {
    ...
    try {
      ...
      this.ctx.log(`validateField [${fieldKey}]: ${err.message}`, "error");
      throw new Error(`Validate field "${fieldKey}" failed: ${err.message}`);
    }
  }
  ...
  async validateDropdown(fieldKey) {
    ...
    try {
      ...
      this.ctx.log(`validateDropdown [${fieldKey}]: ${err.message}`, "error");
      throw new Error(`Validate dropdown "${fieldKey}" failed: ${err.message}`);
    }
  }
  ...
  async validateMulti(fieldKey) {
    ...
    try {
      ...
      this.ctx.log(`validateMulti [${fieldKey}]: ${err.message}`, "error");
      throw new Error(`Validate multi "${fieldKey}" failed: ${err.message}`);
    }
  }
  ...
  async validateCheckbox(fieldKey) {
    ...
    try {
      ...
      this.ctx.log(`validateCheckbox [${fieldKey}]: ${err.message}`, "error");
      throw new Error(`Validate checkbox "${fieldKey}" failed: ${err.message}`);
    }
  }
  ...
  async validateRadio(fieldKey) {
    ...
    try {
      ...
      this.ctx.log(`validateRadio [${fieldKey}]: ${err.message}`, "error");
      throw new Error(`Validate radio "${fieldKey}" failed: ${err.message}`);
    }
  }
